...
ecp_benchmarks = ['XSBench','miniGAN','CRADL','sw4lite','Laghos','bert_large','UNet','Resnet50','lammps']
ecp_benchmarks = ['CRADL','bert_large','UNet','Resnet50']
ecp_benchmarks = ['bert_large']
